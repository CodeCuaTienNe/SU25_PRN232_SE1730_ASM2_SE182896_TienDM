...
namespace DNATestingSystem.BlazorWAS.GraphQLClients.TienDM.Models
{
    ...
    // GraphQL Response classes for DTOs
    public partial class AppointmentsTienDmDisplayDtosGraphQLResponse
    {
        public List<AppointmentsTienDmDisplayDto>? allAppointmentsDisplay { get; set; }
    }

    public partial class AppointmentsTienDmDisplayDtoGraphQLResponse
    {
        public AppointmentsTienDmDisplayDto? appointmentDisplayById { get; set; }
    }

    public partial class CreateAppointmentDtoResponse
    {
        public int createAppointment { get; set; }
    }

    public partial class UpdateAppointmentDtoResponse
    {
