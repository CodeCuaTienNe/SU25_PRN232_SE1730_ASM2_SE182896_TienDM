...
public partial class AppointmentsTienDm
{
    ...
    // Navigation properties - Remove JsonIgnore to allow serialization for display  
    public virtual SystemUserAccount? UserAccount { get; set; }    //for search, get all
    public partial class AppointmentsTienDmsGraphQLResponses
    {
        public List<AppointmentsTienDm>? allAppointments { get; set; }
    }

    //get by ID
    public partial class AppointmentsTienDmsGraphQLResponse
    {
        public AppointmentsTienDm? appointmentsTienDm { get; set; }
    }
